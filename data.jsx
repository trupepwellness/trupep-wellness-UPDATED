              ...
              <>
                ...
                <div style={{ padding: "24px 32px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 24 }}>
                    <span style={{ fontSize: 11, letterSpacing: 2, color: GRAY }}>SUBTOTAL</span>
                    <span className="serif" style={{ fontSize: 28, color: GOLD }}>${total}</span>
                  </div>
...
const STACKS = [
  ...
  {
    id: "glow-stack", name:"Glow & Aesthetics Stack", icon:"✧", stock:"in_stock",
    tagline:"Premium Aesthetic Wellness Protocol",
    desc:"GLOW Blend (70mg) + MT-1 for natural pigmentation. The GLOW blend already contains GHK-Cu, BPC-157, and TB-500 — a complete inside-out aesthetic transformation. No duplicate compounds.",
    items:[{name:"GLOW TruPep Blend 70 mg",price:135},{name:"Melanotan I (MT-1) 10 mg",price:80}],
    total:215, stackPrice:190,
    benefits:["Skin radiance & firmness","Collagen support (via GLOW)","Natural pigmentation","Cellular renewal"] }},port React, { useState, useEffect, useRef } from 'react'
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        <div className="footer-inner" style={{ display: "flex", gap: 60, flexWrap: "wrap", marginBottom: 60 }}>
          ...
          <div style={{ flex: 1, display: "flex", gap: 60, flexWrap: "wrap" }}>
            ...
            <div>
              <div style={{ fontSize: 9, letterSpacing: 3, color: GOLD, textTransform: "uppercase", marginBottom: 20 }}>Legal</div>
              {[["privacy","Privacy Policy"],["terms","Terms of Service"],["disclaimer","Research Disclaimer"],["refund","Refund & Shipping"]].map(([p,l]) => (
                <button key={p} onClick={() => setPage(p)} style={{
                  display: "block", background: "none", border: "none",
                  color: "rgba(255,255,255,0.88)", cursor: "pointer",
                  fontSize: 12, letterSpacing: 1, marginBottom: 12,
