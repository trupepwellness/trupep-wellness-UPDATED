        ...
        <div style={{ marginBottom:80 }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(300px,1fr))", gap:24 }}>
            {[
              ...
              <div key={v.id} style={{ background:SURFACE2, border:`1px solid rgba(201,168,76,0.15)`, overflow:"hidden" }}>
                ...
                <div style={{ padding:"16px 20px", borderTop:`1px solid rgba(201,168,76,0.1)` }}>
                  <div style={{ fontSize:13, color:GOLD, fontFamily:"'Cormorant Garamond',serif", fontWeight:400, marginBottom:6 }}>{v.title}</div>
                  <div style={{ fontSize:11, color:"rgba(255,255,255,0.5)", lineHeight:1.6 }}>{v.desc}</div>
                </div>
              </div>
            ))}
          </div>
