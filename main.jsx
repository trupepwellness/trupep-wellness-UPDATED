  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", marginBottom:44 }}>
      ...
      <div style={{ position:"relative", animation:"float 3.5s ease-in-out infinite" }}>
        ...
        {/* Rotating gold aura ring — thin arc, large diffused glow */}
        <div className="logo-ring" style={{
          ...
          background:`conic-gradient(
            transparent 0deg,
            rgba(201,168,76,0.95) 3deg,
            rgba(255,255,220,1.0) 6deg,
            rgba(201,168,76,0.95) 9deg,
            transparent 14deg,
            transparent 360deg
          )`,
          borderRadius:"50%",
        ...
        {/* Second pass — wider glow halo from same ring */}
        <div className="logo-ring" style={{
          position:"absolute",
          top:"50%", left:"50%",
          ...
          background:`conic-gradient(
            ...
            rgba(201,168,76,0.55) 7deg,
            rgba(245,217,128,0.45) 12deg,
            rgba(201,168,76,0.30) 18deg,
            transparent 28deg,
            transparent 360deg
          )`,
          borderRadius:"50%",
          maskImage:"radial-gradient(transparent 38%, black 58%)",
          WebkitMaskImage:"radial-gradient(transparent 38%, black 58%)",
          pointerEvents:"none",
          filter:"blur(6px)",
        }} />
