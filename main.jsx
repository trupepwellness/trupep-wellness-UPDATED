          ...
          {STACKS.map(stack => (
            <div key={stack.id} className="card-hover gold-anim-card" style={{
              ...
              <div style={{ padding: "20px 32px" }}>
                <div style={{ fontSize: 9, letterSpacing: 3, color: "rgba(255,255,255,0.88)", textTransform: "uppercase", marginBottom: 12 }}>Includes</div>
                {stack.items.map((item, i) => (
                  <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                    ...
                    <span style={{ fontSize: 12, color: "rgba(255,255,255,0.88)" }}>${item.price}</span>
                  </div>
                ))}
              </div>
              ...
              <div style={{ padding: "0 32px 20px" }}>
                <div style={{ fontSize: 9, letterSpacing: 3, color: "rgba(255,255,255,0.88)", textTransform: "uppercase", marginBottom: 12 }}>Key Benefits</div>
              ...
              <div style={{ padding: "20px 32px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                  <div>
                    <div style={{ fontSize: 9, letterSpacing: 2, color: "rgba(255,255,255,0.88)", textTransform: "uppercase", marginBottom: 4 }}>Stack Price</div>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
                      <span className="serif" style={{ fontSize: 32, color: GOLD }}>${stack.stackPrice}</span>
                      <span style={{ fontSize: 12, color: "rgba(255,255,255,0.88)", textDecoration: "line-through" }}>${stack.total}</span>
                    </div>
                  </div>
          ...
          <div style={{ flex: 1, minWidth: 280 }}>
            {sent ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                <p style={{ fontSize: 10, color: "rgba(255,255,255,0.88)", letterSpacing: 0.5, lineHeight: 1.7 }}>
  ...
  return (
    <div style={{ paddingTop:80, background:BLACK, minHeight:"100vh", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, color: "rgba(255,255,255,0.88)", letterSpacing: 2, marginTop: 8 }}>5.0 AVERAGE RATING · {testimonials.length} REVIEWS</div>
      </div>
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  ...
                  <div style={{ fontSize: 10, color: "rgba(255,255,255,0.88)", letterSpacing: 1, marginTop: 2 }}>{t.location}</div>
                </div>
                <div style={{ fontSize: 9, letterSpacing: 2, color: "rgba(255,255,255,0.9)", textTransform: "uppercase" }}>{t.category}</div>
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <div style={{ paddingTop:80, background:BLACK, minHeight:"100vh", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ padding:"80px 40px 60px", textAlign:"center", background:`linear-gradient(180deg,${SURFACE} 0%,${BLACK} 100%)` }}>
        ...
        <p style={{ color:"rgba(255,255,255,0.90)", fontSize:13, fontWeight:300, maxWidth:600, margin:"0 auto" }}>
            ...
            {result && !result.error && (
              <div style={{ display:"flex", flexDirection:"column", gap:2 }}>
                ...
                {[
                  ...
                  <div key={label} style={{ background:SURFACE2, padding:"20px 24px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                    <div>
                      ...
                      <div style={{ fontSize:10, color:"rgba(255,255,255,0.88)", marginTop:2 }}>{note}</div>
                    </div>
                ...
                <div style={{ padding:"16px 20px", background:"rgba(201,168,76,0.04)", border:`1px solid rgba(201,168,76,0.15)`, marginTop:8 }}>
                  <div style={{ fontSize:10, color:"rgba(255,255,255,0.90)", lineHeight:1.8, letterSpacing:0.3 }}>
      ...
      <div style={{ maxWidth: 480, width: "100%", animation: "fadeInUp 0.6s ease" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center" }}>
          ...
          <button onClick={() => setDeclined(true)} style={{
            ...
            color: "rgba(255,255,255,0.88)", cursor: "pointer", padding: "13px 36px",
            fontSize: 11, letterSpacing: 2, fontFamily: "'Montserrat', sans-serif",
            width: "100%", maxWidth: 360,
            transition: "all 0.2s",
          }}
            onMouseEnter={e => e.currentTarget.style.borderColor = "rgba(255,255,255,0.88)"}
        ...
        <p style={{ fontSize: 10, color: "rgba(255,255,255,0.9)", marginTop: 32, lineHeight: 1.7, letterSpacing: 0.3 }}>
