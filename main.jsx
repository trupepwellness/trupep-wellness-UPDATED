...
function GoldBorder() {
  const edgeBase = {
    ...
    background: `linear-gradient(90deg, transparent, rgba(201,168,76,0.55), rgba(232,201,106,0.7), rgba(201,168,76,0.55), transparent)`,
    boxShadow: "0 0 6px 1px rgba(201,168,76,0.12)",
  };
  const edgeBaseV = {
    position: "fixed", zIndex: 9999, pointerEvents: "none",
    background: `linear-gradient(180deg, transparent, rgba(201,168,76,0.55), rgba(232,201,106,0.7), rgba(201,168,76,0.55), transparent)`,
    boxShadow: "0 0 6px 1px rgba(201,168,76,0.12)",
  };
  ...
  const cornerStyle = (top, left, right, bottom) => ({
    ...
    background: `radial-gradient(circle, rgba(255,245,200,0.9), rgba(201,168,76,0.7))`,
    boxShadow: "0 0 5px 2px rgba(201,168,76,0.18)",
    animation: "goldCornerPulse 4s ease-in-out infinite",
    top, left, right, bottom,
  });

  return (
    <>
      <div style={{ ...edgeBase, top: 0, left: 0, right: 0, height: 1 }} />
      <div style={{ ...edgeBase, bottom: 0, left: 0, right: 0, height: 1 }} />
      <div style={{ ...edgeBaseV, top: 0, left: 0, bottom: 0, width: 1 }} />
      <div style={{ ...edgeBaseV, top: 0, right: 0, bottom: 0, width: 1 }} />
