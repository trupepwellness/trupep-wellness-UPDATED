...
const G = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .orbit-cw{animation:orbitCW 5s linear infinite}
  .orbit-ccw{animation:orbitCCW 7s linear infinite}
  .logo-ring{animation:logoRing 4s linear infinite}
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", marginBottom:44 }}>
      ...
      <div style={{ position:"relative", animation:"float 3.5s ease-in-out infinite" }}>
        ...
        {/* Rotating gold aura ring — orbits around the logo */}
        <div className="logo-ring" style={{
          ...
          background:`conic-gradient(
            ...
            rgba(201,168,76,0.85) 22deg,
            rgba(245,217,128,1.0) 34deg,
            rgba(201,168,76,0.85) 46deg,
            transparent 70deg,
            transparent 360deg
          )`,
          borderRadius:"50%",
          maskImage:"radial-gradient(transparent 42%, black 52%)",
          WebkitMaskImage:"radial-gradient(transparent 42%, black 52%)",
          pointerEvents:"none",
          filter:"blur(1px)",
        }} />
...
function ProductCard({ product, onAdd, idx = 0 }) {
  ...
  const orbitClass = idx % 2 === 0 ? "orbit-cw" : "orbit-ccw";
  return (
    /* Orbit glow wrapper */
    <div style={{ position:"relative", padding:2, borderRadius:8, overflow:"hidden" }}>
      {/* Circling gold arc */}
      <div className={orbitClass} style={{
        position:"absolute", top:"50%", left:"50%",
        width:"200%", height:"200%",
        background:`conic-gradient(transparent 0deg, rgba(201,168,76,0.0) 0deg, rgba(201,168,76,0.85) 18deg, rgba(245,217,128,0.95) 28deg, rgba(201,168,76,0.85) 40deg, transparent 58deg, transparent 360deg)`,
        pointerEvents:"none",
        filter:"blur(0.5px)",
      }} />
      {/* Inner card with solid bg so only the 2px edge glows */}
      <div className="card-hover"
        style={{
          border:`1px solid rgba(201,168,76,0.45)`, borderRadius:6,
          padding:24, display:"flex", flexDirection:"column",
          background:`linear-gradient(145deg, rgba(22,19,10,1), rgba(15,13,7,1))`,
      ...
      <div className="reveal" style={{ padding:"52px 24px" }}>
        <div style={{ maxWidth:900, margin:"0 auto", display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))", gap:24, textAlign:"center" }}>
          {[["25+","Compounds"],["7","Protocol Stacks"],["Miami","Based"],["Free","Consultation"]].map(([n, l], i) => (
            <div key={l} style={{ position:"relative", padding:2, borderRadius:8, overflow:"hidden" }}>
              <div className={i % 2 === 0 ? "orbit-cw" : "orbit-ccw"} style={{
                position:"absolute", top:"50%", left:"50%",
                width:"200%", height:"200%",
                background:`conic-gradient(transparent 0deg, rgba(201,168,76,0.85) 18deg, rgba(245,217,128,0.95) 28deg, rgba(201,168,76,0.85) 40deg, transparent 58deg, transparent 360deg)`,
                pointerEvents:"none",
              }} />
              <div style={{ padding:"24px 16px", border:`1px solid rgba(201,168,76,0.4)`, borderRadius:6, background:`rgba(18,15,8,1)`, textAlign:"center", position:"relative", zIndex:1 }}>
        ...
        <div style={{ maxWidth:1100, margin:"0 auto" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(270px,1fr))", gap:22 }}>
            {TESTIMONIALS.map((t, i) => (
              <div key={i} className="reveal" style={{ position:"relative", padding:2, borderRadius:8, overflow:"hidden" }}>
                <div className={i % 2 === 0 ? "orbit-cw" : "orbit-ccw"} style={{
                  position:"absolute", top:"50%", left:"50%",
                  width:"200%", height:"200%",
                  background:`conic-gradient(transparent 0deg, rgba(201,168,76,0.85) 18deg, rgba(245,217,128,0.95) 28deg, rgba(201,168,76,0.85) 40deg, transparent 58deg, transparent 360deg)`,
                ...
                <div className="card-hover"
                  style={{ padding:28, border:`1px solid rgba(201,168,76,0.4)`, borderRadius:6, background:`rgba(18,15,8,1)`, position:"relative", zIndex:1 }}>
      ...
      <div style={{ maxWidth:1160, margin:"0 auto" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(320px,1fr))", gap:24, marginBottom:60 }}>
          {STACKS.map((s, si) => {
            ...
            return (
              <div key={s.id} style={{ position:"relative", padding:2, borderRadius:10, overflow:"hidden" }}>
                {/* Orbiting arc — alternates CW/CCW */}
                <div className={si % 2 === 0 ? "orbit-cw" : "orbit-ccw"} style={{
                  position:"absolute", top:"50%", left:"50%",
                  width:"200%", height:"200%",
                  background:`conic-gradient(transparent 0deg, rgba(201,168,76,0.85) 18deg, rgba(245,217,128,0.95) 28deg, rgba(201,168,76,0.85) 40deg, transparent 58deg, transparent 360deg)`,
                  pointerEvents:"none",
              ...
              <div className={isOpen ? "" : "card-hover"}
                style={{
                  border:`1px solid ${isOpen ? GOLD : "rgba(201,168,76,0.40)"}`, borderRadius:8,
                  background:`linear-gradient(145deg, rgba(22,19,10,1), rgba(15,13,7,1))`,
                  backdropFilter:"blur(8px)",
                  transition:"all .25s",
