    ...
    <>
      <style>{`
        ...
        @keyframes goldCornerPulse {
          0%, 100% { box-shadow: 0 0 10px 3px rgba(201,168,76,0.55), 0 0 4px 1px rgba(201,168,76,0.9); }
          50%       { box-shadow: 0 0 20px 6px rgba(255,235,100,0.80), 0 0 8px 2px #fff; }
        }
        .gold-edge-top, .gold-edge-bottom {
          position: fixed; left: 0; right: 0; height: 3px;
          z-index: 9999; pointer-events: none;
          background: linear-gradient(90deg,
            rgba(100,75,20,0.3) 0%, rgba(201,168,76,0.7) 20%,
            rgba(255,235,100,1) 35%, rgba(201,168,76,0.7) 50%,
            rgba(100,75,20,0.3) 65%, rgba(201,168,76,0.7) 80%,
            rgba(255,235,100,1) 95%
          );
          background-size: 300% 100%;
          box-shadow: 0 0 14px 2px rgba(201,168,76,0.45);
        }
        .gold-edge-top    { top: 0;    animation: travelH 5s linear infinite; }
        .gold-edge-bottom { bottom: 0; animation: travelH 5s linear infinite reverse; }
        .gold-edge-left, .gold-edge-right {
        ...
        .gold-edge-left  { left: 0;  animation: travelV 5s linear infinite; }
        .gold-edge-right { right: 0; animation: travelV 5s linear infinite reverse; }
        .gold-corner-gem {
          position: fixed; width: 10px; height: 10px; border-radius: 50%;
          z-index: 10000; pointer-events: none;
          background: radial-gradient(circle at 35% 35%, #fffbe8, #C9A84C, #A07830);
          animation: goldCornerPulse 3s ease-in-out infinite;
        }
      `}</style>
      <div className="gold-edge-top" />
      <div className="gold-edge-bottom" />
      <div className="gold-edge-left" />
      <div className="gold-edge-right" />
      <div className="gold-corner-gem" style={{ top:0, left:0 }} />
      <div className="gold-corner-gem" style={{ top:0, right:0, animationDelay:"0.75s" }} />
      <div className="gold-corner-gem" style={{ bottom:0, right:0, animationDelay:"1.5s" }} />
      <div className="gold-corner-gem" style={{ bottom:0, left:0, animationDelay:"2.25s" }} />
    </>
  );
}
    ...
    <div id="print-insert" style={{ background:WHITE, color:"#111", fontFamily:"'Montserrat',sans-serif", padding:0, margin:0 }}>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:24, paddingBottom:20, borderBottom:"2px solid #A07830" }}>
        <div>
          ...
          <div style={{ fontSize:10, letterSpacing:3, color: "#fff", textTransform:"uppercase", marginTop:2 }}>Advanced Peptide Wellness</div>
        </div>
        <div style={{ textAlign:"right" }}>
          <div style={{ fontSize:11, color: "#fff" }}>trupepwellness.com</div>
          <div style={{ fontSize:11, color: "#fff" }}>423-444-3668</div>
          <div style={{ fontSize:11, color: "#fff" }}>trupepwellness@gmail.com</div>
        </div>
      </div>
      ...
      <div className="two-col">
        ...
        <div>
          ...
          <div className="insert-section">
            ...
            <div style={{ fontSize:10, color: "#fff", marginTop:8 }}>Or use our online calculator — scan QR code below</div>
          </div>
          ...
          <div className="qr-box">
            ...
            <div style={{ fontSize:10, color: "#fff" }}>How-To Guides · Peptide Calculator · FAQs</div>
          </div>
        </div>
      </div>

      {/* Footer */}
      <div style={{ marginTop:24, paddingTop:16, borderTop:"1px solid #e0d5c0", fontSize:9, color: "#fff", lineHeight:1.8 }}>
        <strong style={{ color: "#fff" }}>DISCLAIMER:</strong> All TruPep Wellness products are for research and wellness purposes only. These statements have not been evaluated by the FDA. Not intended to diagnose, treat, cure, or prevent any disease. Consult a qualified healthcare professional before use. For questions: trupepwellness@gmail.com · 423-444-3668 · Miami, Florida
      </div>
...
function AgeGate({ onConfirm }) {
  ...
  if (declined) return (
    <div style={{
      ...
      <h2 className="serif" style={{ fontSize: 32, fontWeight: 300, color: "#fff", marginBottom: 16 }}>
        We're Sorry
      </h2>
      <p style={{ fontSize: 13, color: "#fff", lineHeight: 1.8, maxWidth: 400 }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 480, width: "100%", animation: "fadeInUp 0.6s ease" }}>
        ...
        <h1 className="serif" style={{ fontSize: "clamp(28px, 5vw, 48px)", fontWeight: 300, color: "#fff", marginBottom: 16, letterSpacing: -0.5 }}>
          Are You 18 or Older?
        </h1>

        <p style={{ fontSize: 13, color: "#fff", lineHeight: 1.9, marginBottom: 40, fontWeight: 300 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center" }}>
          ...
          <button onClick={() => setDeclined(true)} style={{
            ...
            color: "#fff", cursor: "pointer", padding: "13px 36px",
        ...
        <p style={{ fontSize: 10, color: "#fff", marginTop: 32, lineHeight: 1.7, letterSpacing: 0.3 }}>
