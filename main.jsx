...
const G = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .orbit-cw{animation:orbitCW 11s linear infinite}
  .orbit-ccw{animation:orbitCCW 15s linear infinite}
  .logo-ring{animation:logoRing 5s linear infinite}
      ...
      <div style={{ position:"relative", animation:"float 3.5s ease-in-out infinite" }}>
        ...
        <div className="logo-ring" style={{
          ...
          background:`conic-gradient(
            transparent 0deg,
            rgba(201,168,76,0.0) 2deg,
            rgba(201,168,76,0.80) 9deg,
            rgba(245,217,128,0.95) 14deg,
            rgba(201,168,76,0.80) 19deg,
            transparent 28deg,
            transparent 360deg
          )`,
          borderRadius:"50%",
  ...
  return (
    ...
    <div style={{ position:"relative", padding:2, borderRadius:8, overflow:"hidden" }}>
      ...
      <div className={orbitClass} style={{
        ...
        background:`conic-gradient(transparent 0deg, rgba(201,168,76,0.70) 10deg, rgba(245,217,128,0.85) 17deg, rgba(201,168,76,0.70) 24deg, transparent 36deg, transparent 360deg)`,
        pointerEvents:"none",
        filter:"blur(0.5px)",
      }} />
