...
function FloatingHeroLogo() {
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", marginBottom:44 }}>
      {/* Gold ring + floating primary logo */}
      <div style={{ position:"relative", animation:"float 3.5s ease-in-out infinite" }}>
        ...
        <div style={{
          ...
          boxShadow:`0 0 30px rgba(201,168,76,0.45), inset 0 0 30px rgba(201,168,76,0.08)`,
        }} />
        ...
        <img
          ...
          style={{
            ...
            filter:`drop-shadow(0 0 28px rgba(201,168,76,0.75)) drop-shadow(0 0 10px rgba(201,168,76,0.45))`,
          }}
        />
      </div>

      {/* Mirror reflection */}
      <div style={{ transform:"scaleY(-1)", marginTop:3, lineHeight:0 }}>
        <div style={{ animation:"floatMirror 3.5s ease-in-out infinite" }}>
          <img
            ...
            style={{
              ...
              maskImage:"linear-gradient(to bottom, rgba(0,0,0,0.38) 0%, transparent 62%)",
              WebkitMaskImage:"linear-gradient(to bottom, rgba(0,0,0,0.38) 0%, transparent 62%)",
            }}
          />
        </div>
      </div>
