        ...
        {!submitted ? (
          <>
            <div style={{ textAlign: "center", marginBottom: 32 }}>
              ...
              <p style={{ fontSize: 13, color: WHITE, lineHeight: 1.8, fontWeight: 300 }}>
              ...
              <p style={{ fontSize: 12, color: WHITE, letterSpacing: 1 }}>YOUR FIRST ORDER</p>
            </div>
          ...
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <p style={{ fontSize: 13, color: WHITE, lineHeight: 1.8, marginBottom: 24 }}>
  ...
  return (
    <div style={{ paddingTop: 80, background: BLACK, minHeight: "100vh", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{
        ...
        <p style={{ color: WHITE, fontSize: 13, letterSpacing: 0.5, fontWeight: 300, maxWidth: 600, margin: "0 auto" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 40px" }}>
          ...
          {STACKS.map(stack => (
            <div key={stack.id} className="card-hover gold-anim-card" style={{
              ...
              <div style={{ padding: "32px 32px 20px", borderBottom: `1px solid rgba(201,168,76,0.08)` }}>
                ...
                <p style={{ fontSize: 12, lineHeight: 1.75, color: WHITE, fontWeight: 300 }}>{stack.desc}</p>
              </div>

              {/* Items */}
              <div style={{ padding: "20px 32px" }}>
                <div style={{ fontSize: 9, letterSpacing: 3, color: WHITE, textTransform: "uppercase", marginBottom: 12 }}>Includes</div>
                {stack.items.map((item, i) => (
                  <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: "1px solid rgba(255,255,255,1)" }}>
                    <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                      <div style={{ width: 4, height: 4, borderRadius: "50%", background: GOLD }} />
                      <span style={{ fontSize: 12, color: WHITE }}>{item.name}</span>
                    </div>
                    <span style={{ fontSize: 12, color: WHITE }}>${item.price}</span>
                  </div>
                ))}
              </div>
              ...
              <div style={{ padding: "0 32px 20px" }}>
                <div style={{ fontSize: 9, letterSpacing: 3, color: WHITE, textTransform: "uppercase", marginBottom: 12 }}>Key Benefits</div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                  {stack.benefits.map((b, i) => (
                    <span key={i} style={{
                      fontSize: 9, letterSpacing: 1, padding: "4px 10px",
                      border: "1px solid rgba(201,168,76,0.15)", color: WHITE,
              ...
              {/* Pricing & CTA */}
              <div style={{ padding: "20px 32px", borderTop: "1px solid rgba(255,255,255,1)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                  <div>
                    <div style={{ fontSize: 9, letterSpacing: 2, color: WHITE, textTransform: "uppercase", marginBottom: 4 }}>Stack Price</div>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
                      <span className="serif" style={{ fontSize: 32, color: GOLD }}>${stack.stackPrice}</span>
                      <span style={{ fontSize: 12, color: WHITE, textDecoration: "line-through" }}>${stack.total}</span>
                    </div>
                  </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 13, color: WHITE, lineHeight: 1.8, maxWidth: 500, margin: "0 auto 32px", fontWeight: 300 }}>
  ...
  return (
    <div style={{ paddingTop:80, background:BLACK, minHeight:"100vh", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{
        ...
        <p style={{ color: WHITE, fontSize: 13, fontWeight: 300, maxWidth: 500, margin: "0 auto" }}>
            ...
            {[
              ...
              <div key={title} style={{ marginBottom: 32, display: "flex", gap: 16 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11, lineHeight: 1.7, color: WHITE, fontWeight: 300 }}>{desc}</div>
                </div>
              </div>
            ))}
          ...
          <div style={{ flex: 1, minWidth: 280 }}>
            {sent ? (
              <div style={{ textAlign: "center", padding: "60px 0" }}>
                ...
                <p style={{ fontSize: 13, color: WHITE, lineHeight: 1.8 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                ...
                <p style={{ fontSize: 10, color: WHITE, letterSpacing: 0.5, lineHeight: 1.7 }}>
  ...
  return (
    <div style={{ paddingTop:80, background:BLACK, minHeight:"100vh", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, color: WHITE, letterSpacing: 2, marginTop: 8 }}>5.0 AVERAGE RATING · {testimonials.length} REVIEWS</div>
      </div>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 40px" }}>
        <div className="stacks-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 2 }}>
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="serif" style={{ fontSize: 15, lineHeight: 1.8, color: WHITE, fontStyle: "italic", marginBottom: 24, flex: 1 }}>
                {t.text}
              </p>
              {/* Protocol tag */}
              <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  ...
                  <div style={{ fontSize: 10, color: WHITE, letterSpacing: 1, marginTop: 2 }}>{t.location}</div>
                </div>
                <div style={{ fontSize: 9, letterSpacing: 2, color: WHITE, textTransform: "uppercase" }}>{t.category}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          <p style={{ color: WHITE, fontSize: 13, marginBottom: 32, fontWeight: 300 }}>
...
function GoldBorder() {
  ...
  const thickness = 3;
  // Traveling bright spot position around the perimeter
  const angle = (phase * 1.5) % 360;
  const sinA = Math.sin((angle * Math.PI) / 180);
  const cosA = Math.cos((angle * Math.PI) / 180);

  const shimmerGrad = (axis) => {
    const deg = axis === 'h' ? 90 : 180;
    const pct = Math.round(axis === 'h' ? 50 + cosA * 50 : 50 + sinA * 50);
    return "linear-gradient(" + deg + "deg, rgba(160,120,40,0.5) 0%, rgba(201,168,76,0.8) 30%, rgba(255,225,100,1) " + pct + "%, rgba(201,168,76,0.8) 70%, rgba(160,120,40,0.5) 100%)";
  };

  const glowBase = `0 0 28px 4px rgba(201,168,76,0.55), 0 0 8px 2px rgba(201,168,76,0.85)`;
  const glowBright = `0 0 40px 8px rgba(255,220,80,0.70), 0 0 14px 3px rgba(255,235,120,1)`;

  const topGlow    = sinA < -0.5 ? glowBright : glowBase;
  const bottomGlow = sinA >  0.5 ? glowBright : glowBase;
  const leftGlow   = cosA < -0.5 ? glowBright : glowBase;
  const rightGlow  = cosA >  0.5 ? glowBright : glowBase;
  ...
  const edgeStyle = (pos) => {
    ...
    if (pos === "top")    return { ...base, top: 0, left: 0, right: 0, height: thickness,
      background: shimmerGrad('h'), boxShadow: topGlow };
    if (pos === "bottom") return { ...base, bottom: 0, left: 0, right: 0, height: thickness,
      background: shimmerGrad('h'), boxShadow: bottomGlow };
    if (pos === "left")   return { ...base, top: 0, left: 0, bottom: 0, width: thickness,
      background: shimmerGrad('v'), boxShadow: leftGlow };
    if (pos === "right")  return { ...base, top: 0, right: 0, bottom: 0, width: thickness,
      background: shimmerGrad('v'), boxShadow: rightGlow };
  };

  const cornerGem = (top, left, right, bottom, bright) => ({
    position: "fixed", zIndex: 10000, pointerEvents: "none",
    width: 12, height: 12, borderRadius: "50%",
    background: `radial-gradient(circle at 35% 35%, #fffbe8, ${GOLD_LIGHT}, ${GOLD})`,
    boxShadow: bright
      ? `0 0 20px 6px rgba(255,230,80,0.9), 0 0 8px 2px #fff, 0 0 4px 1px ${GOLD}`
      : `0 0 10px 3px rgba(201,168,76,0.6), 0 0 4px 1px ${GOLD}`,
    animation: "goldCornerPulse 3s ease-in-out infinite",
    top, left, right, bottom,
  });

  const tlBright = angle > 315 || angle < 45;
  const trBright = angle > 45 && angle < 135;
  const brBright = angle > 135 && angle < 225;
  const blBright = angle > 225 && angle < 315;
  ...
  return (
    <>
      ...
      <div style={cornerGem(0, 0, undefined, undefined, tlBright)} />
      <div style={cornerGem(0, undefined, 0, undefined, trBright)} />
      <div style={cornerGem(undefined, undefined, 0, 0, brBright)} />
      <div style={cornerGem(undefined, 0, undefined, 0, blBright)} />
    </>
  );
}
  ...
  return (
    <div style={{ paddingTop:80, background:BLACK, minHeight:"100vh", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ padding:"80px 40px 60px", textAlign:"center", background:`linear-gradient(180deg,${SURFACE} 0%,${BLACK} 100%)` }}>
        ...
        <p style={{ color: WHITE, fontSize:13, fontWeight:300, maxWidth:600, margin:"0 auto" }}>
          ...
          <div>
            ...
            <div style={{ marginBottom:20 }}>
              ...
              <input type="number" placeholder="e.g. 10" value={vialMg}
                ...
                style={inputStyle} />
              <div style={{ fontSize:10, color: WHITE, marginTop:4 }}>The total mg in your peptide vial</div>
            </div>
            ...
            <div style={{ marginBottom:20 }}>
              ...
              <div style={{ display:"flex", gap:8, marginBottom:8, flexWrap:"wrap" }}>
                {["1","2","3"].map(v=>(
                  <button key={v} onClick={()=>setBacMl(v)} style={{
                    ...
                    color: bacMl===v ? GOLD : "rgba(255,255,255,0.92)", cursor:"pointer",
                    fontFamily:"'Montserrat',sans-serif",
                  }}>{v} ml</button>
                ))}
              </div>
              <input type="number" placeholder="or type custom amount" value={bacMl}
                ...
                onBlur={e=>e.target.style.borderColor="rgba(201,168,76,0.25)"}
                style={inputStyle} />
              <div style={{ fontSize:10, color: WHITE, marginTop:4 }}>TruPep recommends 1–2ml per vial</div>
            </div>
            ...
            <div style={{ marginBottom:20 }}>
              ...
              <input type="number" placeholder="e.g. 250" value={doseMcg}
                ...
                onBlur={e=>e.target.style.borderColor="rgba(201,168,76,0.25)"}
                style={inputStyle} />
              <div style={{ fontSize:10, color: WHITE, marginTop:4 }}>1mg = 1000mcg. Consult your wellness protocol.</div>
            </div>
              ...
              <div style={{ display:"flex", gap:8 }}>
                {[["100","100 Unit (1ml)"],["50","50 Unit (0.5ml)"]].map(([v,l])=>(
                  <button key={v} onClick={()=>setSyringeType(v)} style={{
                    ...
                    color: syringeType===v ? GOLD : "rgba(255,255,255,0.92)", cursor:"pointer",
          ...
          <div>
            ...
            {!result && (
              <div style={{ padding:"60px 32px", textAlign:"center", border:`1px solid rgba(201,168,76,0.1)`, background:"rgba(201,168,76,0.02)" }}>
                ...
                <div style={{ fontSize:12, color: WHITE, letterSpacing:1 }}>Fill in your values and tap Calculate</div>
              </div>
            )}
            ...
            {result && !result.error && (
              <div style={{ display:"flex", flexDirection:"column", gap:2 }}>
                ...
                <div style={{ background:`linear-gradient(135deg,rgba(201,168,76,0.12),rgba(201,168,76,0.06))`, border:`1px solid rgba(201,168,76,0.3)`, padding:"32px", textAlign:"center" }}>
                  ...
                  <div style={{ fontSize:12, color:"rgba(255,255,255,0.92)", marginTop:8 }}>units on a {result.syringeUnits}-unit insulin syringe</div>
                </div>
                ...
                {[
                  ...
                  <div key={label} style={{ background:SURFACE2, padding:"20px 24px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                    <div>
                      <div style={{ fontSize:10, letterSpacing:2, color: WHITE, textTransform:"uppercase" }}>{label}</div>
                      <div style={{ fontSize:10, color:"rgba(255,255,255,1)", marginTop:2 }}>{note}</div>
                    </div>
                ...
                <div style={{ padding:"16px 20px", background:"rgba(201,168,76,0.04)", border:`1px solid rgba(201,168,76,0.15)`, marginTop:8 }}>
                  <div style={{ fontSize:10, color:WHITE, lineHeight:1.8, letterSpacing:0.3 }}>
                    ⚠ <strong style={{ color:"rgba(255,255,255,0.93)" }}>Research Disclaimer:</strong> This calculator is for informational purposes only. Always consult a qualified healthcare professional before beginning any peptide protocol. Doses vary by individual and peptide compound.
                  </div>
                </div>
            ...
            <div style={{ marginTop:32, padding:"24px", border:`1px solid rgba(201,168,76,0.1)` }}>
              ...
              {[
                ...
                <div key={step} style={{ display:"flex", gap:12, marginBottom:12 }}>
                  ...
                  <div style={{ fontSize:11, color:"rgba(255,255,255,0.92)", fontFamily:"monospace" }}>{formula}</div>
                </div>
              ))}
            </div>
          </div>
    ...
    <div style={{ paddingTop:80, background:BLACK, minHeight:"100vh", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ maxWidth:1000, margin:"0 auto", padding:"60px 40px" }}>
              ...
              >
                ...
                >
                  ...
                  <div style={{ position:"relative", paddingBottom:"56.25%", background:"#000", overflow:"hidden" }}>
                    ...
                    {/* YouTube badge */}
                    <div style={{ position:"absolute", bottom:10, right:10, background:"rgba(0,0,0,0.75)", padding:"3px 8px", fontSize:9, color: WHITE, letterSpacing:1 }}>
                      YOUTUBE
                    </div>
                  </div>
                  {/* Info */}
                  <div style={{ padding:"16px 20px", borderTop:`1px solid rgba(201,168,76,0.1)` }}>
                    ...
                    <div style={{ fontSize:11, color:"rgba(255,255,255,0.92)", lineHeight:1.6, marginBottom:10 }}>{v.desc}</div>
        ...
        <div style={{ marginBottom:80 }}>
          ...
          {steps.map((s,i)=>(
            <div key={s.num} style={{ display:"flex", gap:24, padding:"28px 0", borderBottom:`1px solid rgba(255,255,255,1)` }}>
              ...
              <div>
                ...
                <p style={{ fontSize:13, lineHeight:1.9, color:"rgba(255,255,255,0.93)", fontWeight:300 }}>{s.desc}</p>
              </div>
            </div>
          ))}
        </div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))", gap:2 }}>
            {storage.map(s=>(
              <div key={s.title} style={{ background:SURFACE2, padding:"28px 24px", borderTop:`2px solid rgba(201,168,76,0.3)` }}>
                ...
                <p style={{ fontSize:12, lineHeight:1.8, color:"rgba(255,255,255,0.93)", fontWeight:300 }}>{s.rule}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ marginBottom:80 }}>
          ...
          <div style={{ background:SURFACE, border:`1px solid rgba(201,168,76,0.12)`, padding:"32px" }}>
            {safety.map((s,i)=>(
              <div key={i} style={{ display:"flex", gap:16, padding:"14px 0", borderBottom: i<safety.length-1 ? "1px solid rgba(255,255,255,1)" : "none" }}>
                <div style={{ color:GOLD, fontSize:14, marginTop:1, flexShrink:0 }}>✦</div>
                <p style={{ fontSize:13, lineHeight:1.7, color:"rgba(255,255,255,1)", fontWeight:300 }}>{s}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ marginBottom:80 }}>
          ...
          {[
            ...
            <details key={i} style={{ marginBottom:2 }}>
              ...
              <div style={{ padding:"20px 24px", background:SURFACE, fontSize:13, color:"rgba(255,255,255,0.93)", lineHeight:1.9, fontWeight:300 }}>{a}</div>
            </details>
          ))}
        </div>
        ...
        <div style={{ padding:"48px", textAlign:"center", border:`1px solid rgba(201,168,76,0.15)`, background:"rgba(201,168,76,0.02)" }}>
          ...
          <p style={{ fontSize:13, color:"rgba(255,255,255,0.92)", marginBottom:28, fontWeight:300 }}>Use the TruPep Peptide Calculator to get your exact injection units in seconds.</p>
          <div style={{ display:"flex", gap:16, justifyContent:"center", flexWrap:"wrap" }}>
    ...
    <div id="print-insert" style={{ background:WHITE, color:"#111", fontFamily:"'Montserrat',sans-serif", padding:0, margin:0 }}>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:24, paddingBottom:20, borderBottom:"2px solid #A07830" }}>
        <div>
          ...
          <div style={{ fontSize:10, letterSpacing:3, color: WHITE", textTransform:"uppercase", marginTop:2 }}>Advanced Peptide Wellness</div>
        </div>
        <div style={{ textAlign:"right" }}>
          <div style={{ fontSize:11, color: WHITE" }}>trupepwellness.com</div>
          <div style={{ fontSize:11, color: WHITE" }}>423-444-3668</div>
          <div style={{ fontSize:11, color: WHITE" }}>trupepwellness@gmail.com</div>
        </div>
      </div>
      ...
      <div className="two-col">
        ...
        <div>
          ...
          <div className="insert-section">
            ...
            <div style={{ fontSize:10, color: WHITE", marginTop:8 }}>Or use our online calculator — scan QR code below</div>
          </div>
          ...
          <div className="qr-box">
            ...
            <div style={{ fontSize:10, color: WHITE" }}>How-To Guides · Peptide Calculator · FAQs</div>
          </div>
        </div>
      </div>

      {/* Footer */}
      <div style={{ marginTop:24, paddingTop:16, borderTop:"1px solid #e0d5c0", fontSize:9, color: WHITE", lineHeight:1.8 }}>
        <strong style={{ color: WHITE" }}>DISCLAIMER:</strong> All TruPep Wellness products are for research and wellness purposes only. These statements have not been evaluated by the FDA. Not intended to diagnose, treat, cure, or prevent any disease. Consult a qualified healthcare professional before use. For questions: trupepwellness@gmail.com · 423-444-3668 · Miami, Florida
      </div>
...
function AgeGate({ onConfirm }) {
  ...
  if (declined) return (
    <div style={{
      ...
      <p style={{ fontSize: 13, color: WHITE, lineHeight: 1.8, maxWidth: 400 }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 480, width: "100%", animation: "fadeInUp 0.6s ease" }}>
        ...
        <p style={{ fontSize: 13, color: WHITE, lineHeight: 1.9, marginBottom: 40, fontWeight: 300 }}>
        ...
        <p style={{ fontSize: 10, color: WHITE, marginTop: 32, lineHeight: 1.7, letterSpacing: 0.3 }}>
